...
var createDBState = function(db, obj) {
  ...
  */
  ...
  .then(function() {
    if (obj.books) {
      return obj.books.reduce(function(seq, book) {
  ...
  .then(function() {
    if (obj.copies) {
      return obj.copies.reduce(function(seq, copy, index) {
  ...
  .then(function() {
    if (obj.bookrequests) {
      return obj.bookrequests.reduce(function(seq, request) {
  ...
  .then(function() {
    if (obj.borrowing) {
      return obj.borrowing.reduce(function(seq, borrowing) {
