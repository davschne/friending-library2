...
exports.formatBook = function(book, additions) {
  ...
  out.isbn           = book.ISBN[13] || book.ISBN[10];
  ...
  out.imagelink      = book.imageLinks.thumbnail;
  out.imagelinksmall = book.imageLinks.smallThumbnail;
...
exports.insertCopy = function(db, book, owner) {
  ...
  return db.query(SQL, [book.ISBN[13] || book.ISBN[10], owner.uid])
    .then(function(res) {
      return res;
    });
};
...
exports.insertBookRequest = function(db, requester, copyid) {
  ...
  return db.query(SQL, [requester.uid, copyid]);
};
...
exports.insertBorrowing = function(db, borrower, copyid) {
  ...
  return db.query(SQL, [borrower.uid, copyid]);
};
