...
module.exports = {
  ...
  createCopy: function(pg, uid, ISBN, title, subtitle, authors, categories, publisher, publishedDate, description, pageCount, language, imageLink, imageLinkSmall) {
  ...
  deleteCopy: function(pg, copyid) {
    return pg.api.deleteCopyAsync([copyid]);
  },
  getOwnBooks: function(pg, uid) {
